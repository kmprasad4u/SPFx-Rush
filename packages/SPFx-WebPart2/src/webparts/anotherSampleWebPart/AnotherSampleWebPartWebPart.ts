...
import styles from './AnotherSampleWebPartWebPart.module.scss';
import * as strings from 'AnotherSampleWebPartWebPartStrings';

export interface IAnotherSampleWebPartWebPartProps {
  description: string;
}

export default class AnotherSampleWebPartWebPart extends BaseClientSideWebPart<IAnotherSampleWebPartWebPartProps> {
